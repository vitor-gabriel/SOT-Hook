...
struct FHitResult
{
	unsigned char                                      bBlockingHit : 1;                                         // 0x00(0x01)
	unsigned char                                      bStartPenetrating : 1;                                    // 0x00(0x01)
	unsigned char                                      UnknownData00[0x3];                                       // 0x01(0x03) MISSED OFFSET
	float                                              Time;                                                     // 0x04(0x04) (ZeroConstructor, IsPlainOldData)
	float                                              Distance;                                                 // 0x08(0x04) (ZeroConstructor, IsPlainOldData)
	...
	char pad_5894[0x48];
	float                                              PenetrationDepth;                                         // 0x54(0x04) (ZeroConstructor, IsPlainOldData)
	int                                                Item;                                                     // 0x58(0x04) (ZeroConstructor, IsPlainOldData)
	...
	char pad_3424[0x18];
	struct FName                                       BoneName;                                                 // 0x74(0x08) (ZeroConstructor, IsPlainOldData)
	int                                                FaceIndex;                                                // 0x7C(0x04) (ZeroConstructor, IsPlainOldData)
};
...
struct AAthenaPlayerCharacter : AAthenaCharacter {
	char pad[0x1A8];  // с 2.7.3  + 8   2.8.0
	struct UDrowningComponent* DrowningComponent; // 0xd98(0x08) +8 
	char pad2[0xF10]; //2.3.3 0xF28  2.8.0 0xF10
...
struct AOnlineAthenaPlayerController {
	char pad_00[0x1590];
	char UnknownData_1590[0x8]; // 0x1590(0x08)
	char LogoutNoteCompletionIdent[0x8]; // 0x1598(0x08)
	char UnknownData_15A0[0x19]; // 0x15A0(0x19)
	bool IdleDisconnectEnabled; // 0x15b9(0x01)
	char UnknownData_15ba[0x9e]; // 0x15ba(0x9e)
};
...
struct ALightingController {
	...
	char pad_1[0x70]; // 0x738(0x70)
	AActor* Fog; // 0x7A8(0x08)
